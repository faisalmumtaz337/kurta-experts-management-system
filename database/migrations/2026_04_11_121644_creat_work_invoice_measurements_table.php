...
return new class extends Migration
{
    ...
    {
        Schema::create('work_invoice_measurements', function (Blueprint $table) {
            $table->id();

            $table->foreignId('work_invoice_item_id')->constrained()->cascadeOnDelete();
            ...
            $table->text('extra_notes')->nullable(); // fitting notes
