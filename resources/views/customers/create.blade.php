        ...
        <div class="row">
          ...
          <div class="col-sm-12 mb-3">
            <x-breadcrumb :items="[
                ...
                ['title' => 'Add New Customer', 'url' => '', 'icon' => 'fa-solid fa-plus']
            ]" />
          </div>
        </div>
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Add New Customer Information</h4>
            <form class="forms-sample" enctype="multipart/form-data" action="{{ route('customers.store') }}" method="POST">
              @csrf
              <div class="row">
                <div class="col-sm-6">
              ...
              <div class="form-group">
                <x-text-input name="address" label="Address" placeholder="Address" />
              </div>
